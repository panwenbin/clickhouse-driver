...
class MapColumn(Column):
    ...
    def read_items(self, n_items, buf):
        ...
        keys = self.key_column.read_items(last_offset, buf)
        values = self.value_column.read_items(last_offset, buf)
    ...
    def write_items(self, items, buf):
        ...
        self.key_column.write_items(keys, buf)
        self.value_column.write_items(values, buf)
